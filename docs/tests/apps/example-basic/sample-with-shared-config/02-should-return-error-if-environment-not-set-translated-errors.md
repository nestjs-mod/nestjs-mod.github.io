---
id: tests-apps-example-basic-src-app-sample-with-shared-config-02-should-return-error-if-environment-not-set-translated-errors-4c97f6d28d
title: "EnvModel: Returns error if environment not set (translated errors)"
sidebar_label: "02 Returns error if environment not set (translated errors)"
...
- **File**: [sample-with-shared-config.controller.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/apps/example-basic/src/app/sample-with-shared-config/sample-with-shared-config.controller.spec.ts#L33)
- **Line**: 33

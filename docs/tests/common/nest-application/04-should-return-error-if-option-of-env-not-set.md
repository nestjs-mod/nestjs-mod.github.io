---
id: tests-libs-common-src-lib-nest-application-04-should-return-error-if-option-of-env-not-set-b188b307ec
title: "EnvModel: Returns error if option of env not set"
sidebar_label: "04 Returns error if option of env not set"
...
- **File**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/libs/common/src/lib/nest-application/utils.spec.ts#L158)
- **Line**: 158

---
id: tests-libs-common-src-lib-nest-application-05-should-return-option-value-from-service-cd1e9eb5ab
title: "EnvModel: Returns option value from service"
sidebar_label: "05 Returns option value from service"
...
- **File**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/libs/common/src/lib/nest-application/utils.spec.ts#L182)
- **Line**: 182

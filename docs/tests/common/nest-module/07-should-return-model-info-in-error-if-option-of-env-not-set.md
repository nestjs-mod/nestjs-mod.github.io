---
id: tests-libs-common-src-lib-nest-module-07-should-return-model-info-in-error-if-option-of-env-not-set-fe4fe1a0db
title: "EnvModel: Returns model info in error if option of env not set"
sidebar_label: "07 Returns model info in error if option of env not set"
...
- **File**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/main/libs/common/src/lib/nest-module/utils.spec.ts#L202)
- **Line**: 202

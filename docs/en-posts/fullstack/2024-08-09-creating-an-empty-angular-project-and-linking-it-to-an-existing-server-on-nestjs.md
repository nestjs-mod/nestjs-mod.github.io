---
title: "Creating an empty Angular project and linking it to an existing server on NestJS"
slug: "/2024-08-09-creating-an-empty-angular-project-and-linking-it-to-an-existing-server-on-nestjs"
sidebar_label: "Creating an empty Angular project and linking it to an existing server on NestJS"
---

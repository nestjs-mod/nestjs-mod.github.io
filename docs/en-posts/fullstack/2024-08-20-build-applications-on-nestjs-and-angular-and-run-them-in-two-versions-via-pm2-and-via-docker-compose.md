---
title: "Build applications on NestJS and Angular and run them in two versions: via PM2 and via Docker Compose"
slug: "/2024-08-20-build-applications-on-nestjs-and-angular-and-run-them-in-two-versions-via-pm2-and-via-docker-compose"
sidebar_label: "Build applications on NestJS and Angular and run them in two versions: via PM2 and via Docker Compose"
---

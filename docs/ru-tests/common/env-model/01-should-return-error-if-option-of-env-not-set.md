---
id: ru-tests-libs-common-src-lib-env-model-01-should-return-error-if-option-of-env-not-set-fe098b774d
...
- **Файл**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/libs/common/src/lib/env-model/utils.spec.ts#L8)
- **Строка**: 8

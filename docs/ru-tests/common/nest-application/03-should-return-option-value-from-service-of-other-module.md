---
id: ru-tests-libs-common-src-lib-nest-application-03-should-return-option-value-from-service-of-other-module-6e7d37ccfa
title: "EnvModel: Возвращает значение опции из сервиса of other module"
sidebar_label: "03 Возвращает значение опции из сервиса of other module"
...
- **Файл**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/libs/common/src/lib/nest-application/utils.spec.ts#L103)
- **Строка**: 103

---
id: ru-tests-libs-common-src-lib-nest-application-04-should-return-error-if-option-of-env-not-set-cfbe28352b
title: "EnvModel: Возвращает ошибку, если option of env not set"
sidebar_label: "04 Возвращает ошибку, если option of env not set"
...
- **Файл**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/libs/common/src/lib/nest-application/utils.spec.ts#L158)
- **Строка**: 158

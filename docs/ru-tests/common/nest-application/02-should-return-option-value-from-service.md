---
id: ru-tests-libs-common-src-lib-nest-application-02-should-return-option-value-from-service-262eaa89d9
title: "EnvModel: Возвращает значение опции из сервиса"
sidebar_label: "02 Возвращает значение опции из сервиса"
...
- **Файл**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/libs/common/src/lib/nest-application/utils.spec.ts#L64)
- **Строка**: 64

---
id: ru-tests-libs-common-src-lib-nest-application-08-should-return-all-feature-options-e93dff6440
title: "EnvModel: Возвращает all feature options"
sidebar_label: "08 Возвращает all feature options"
...
# EnvModel: Возвращает all feature options
...
- **Файл**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/libs/common/src/lib/nest-application/utils.spec.ts#L336)
- **Строка**: 336

---
id: ru-tests-libs-common-src-lib-nest-module-07-should-return-model-info-in-error-if-option-of-env-not-set-d3d73e7108
title: "EnvModel: Возвращает информацию о модели в ошибке, если option of env not set"
sidebar_label: "07 Возвращает информацию о модели в ошибке, если option of env not set"
...
- **Файл**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/main/libs/common/src/lib/nest-module/utils.spec.ts#L202)
- **Строка**: 202

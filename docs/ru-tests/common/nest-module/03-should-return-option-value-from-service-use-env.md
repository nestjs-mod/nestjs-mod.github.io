---
id: ru-tests-libs-common-src-lib-nest-module-03-should-return-option-value-from-service-use-env-7bef4c7979
title: "EnvModel: Возвращает значение опции из сервиса use env"
sidebar_label: "03 Возвращает значение опции из сервиса use env"
...
# EnvModel: Возвращает значение опции из сервиса use env
...
- **Файл**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/libs/common/src/lib/nest-module/utils.spec.ts#L67)
- **Строка**: 67

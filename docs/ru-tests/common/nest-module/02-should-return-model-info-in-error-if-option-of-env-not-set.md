---
id: ru-tests-libs-common-src-lib-nest-module-02-should-return-model-info-in-error-if-option-of-env-not-set-8e0f2e9be1
title: "EnvModel: Возвращает информацию о модели в ошибке, если option of env not set"
sidebar_label: "02 Возвращает информацию о модели в ошибке, если option of env not set"
...
- **Файл**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/main/libs/common/src/lib/nest-module/utils.spec.ts#L33)
- **Строка**: 33

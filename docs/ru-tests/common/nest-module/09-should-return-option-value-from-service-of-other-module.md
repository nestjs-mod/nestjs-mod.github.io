---
id: ru-tests-libs-common-src-lib-nest-module-09-should-return-option-value-from-service-of-other-module-d700572d48
title: "EnvModel: Возвращает значение опции из сервиса of other module"
sidebar_label: "09 Возвращает значение опции из сервиса of other module"
...
- **Файл**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/main/libs/common/src/lib/nest-module/utils.spec.ts#L267)
- **Строка**: 267

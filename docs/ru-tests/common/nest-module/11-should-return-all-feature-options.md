---
id: ru-tests-libs-common-src-lib-nest-module-11-should-return-all-feature-options-ee154466cc
title: "EnvModel: Возвращает all feature options"
sidebar_label: "11 Возвращает all feature options"
...
- **Файл**: [utils.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/libs/common/src/lib/nest-module/utils.spec.ts#L376)
- **Строка**: 376

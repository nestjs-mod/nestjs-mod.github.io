---
id: ru-tests-apps-example-tcp-microservice-src-app-03-error-should-return-90e9387e79
title: "TCP microservice: Возвращает ошибку удалённого вызова"
sidebar_label: "03 Возвращает ошибку удалённого вызова"
...
- **Файл**: [math-two-envs.controller.spec.ts](https://github.com/nestjs-mod/nestjs-mod/blob/master/apps/example-tcp-microservice/src/app/math-two-envs.controller.spec.ts#L118)
- **Строка**: 118

---
title: "Подключение PrismaORM в NestJS-mod приложение и проверка его работы через REST"
slug: "/2024-08-13-подключение-prismaorm-в-nestjs-mod-приложение-и-проверка-его-работы-через-rest"
sidebar_label: "Подключение PrismaORM в NestJS-mod приложение и проверка его работы через REST"
---

---
title: "Добавление базы данных Postgres в проект и запуск миграций через Flyway для NestJS-mod приложения"
slug: "/2024-08-11-добавление-базы-данных-postgres-в-проект-и-запуск-миграций-через-flyway-для-nestjs-mod-приложения"
sidebar_label: "Добавление базы данных Postgres в проект и запуск миграций через Flyway для NestJS-mod приложения"
---
# Добавление базы данных Postgres в проект и запуск миграций через Flyway для NestJS-mod приложения

> **Дата публикации:** 2024-08-11

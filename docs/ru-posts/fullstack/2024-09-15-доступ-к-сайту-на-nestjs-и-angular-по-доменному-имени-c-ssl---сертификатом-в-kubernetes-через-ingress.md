---
title: "Доступ к сайту на NestJS и Angular по доменному имени c SSL - сертификатом в Kubernetes через Ingress"
slug: "/2024-09-15-доступ-к-сайту-на-nestjs-и-angular-по-доменному-имени-c-ssl---сертификатом-в-kubernetes-через-ingress"
sidebar_label: "Доступ к сайту на NestJS и Angular по доменному имени c SSL - сертификатом в Kubernetes через Ingress"
---
